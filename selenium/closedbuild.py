...
driver.get("https://www.closedlooppartners.com/the-center/building-a-circular-food-agriculture-system/")
...
driver.execute_script(f"window,scrollTo(0, 3600);")
time.sleep(2)
...
df.to_csv('closedbuild.csv', index=False)
