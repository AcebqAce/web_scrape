...
base_url = "https://badger.ee/portfolio/"
page_paths = ['cuploop/', 'mate-academy/', 'notably/', 'around/', 'storadera/', 'patchstack/', 'vok-bikes/', 'others/', 'woola/', 'singleearth/']
...
for page_path in page_paths:
    ...
    results = soup.find_all('a', class_='btn btn-primary')
    ...
    df.to_csv('scraped-csv/badger.csv', index=False)
